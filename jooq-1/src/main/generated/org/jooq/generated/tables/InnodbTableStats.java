...
public class InnodbTableStats extends TableImpl<InnodbTableStatsRecord> {
    ...
    private InnodbTableStats(Name alias, Table<InnodbTableStatsRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public InnodbTableStats where(Condition condition) {
        return new InnodbTableStats(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public InnodbTableStats where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public InnodbTableStats where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public InnodbTableStats where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public InnodbTableStats where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public InnodbTableStats where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public InnodbTableStats where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public InnodbTableStats where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public InnodbTableStats whereExists(Select<?> select) {
     ...
     */
    @Override
    public InnodbTableStats whereNotExists(Select<?> select) {
