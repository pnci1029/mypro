...
public class SlaveWorkerInfo extends TableImpl<SlaveWorkerInfoRecord> {
    ...
    private SlaveWorkerInfo(Name alias, Table<SlaveWorkerInfoRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public SlaveWorkerInfo where(Condition condition) {
        return new SlaveWorkerInfo(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public SlaveWorkerInfo where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public SlaveWorkerInfo where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public SlaveWorkerInfo where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public SlaveWorkerInfo where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public SlaveWorkerInfo where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public SlaveWorkerInfo where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public SlaveWorkerInfo where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public SlaveWorkerInfo whereExists(Select<?> select) {
     ...
     */
    @Override
    public SlaveWorkerInfo whereNotExists(Select<?> select) {
