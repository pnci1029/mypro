...
public class SlaveRelayLogInfo extends TableImpl<SlaveRelayLogInfoRecord> {
    ...
    private SlaveRelayLogInfo(Name alias, Table<SlaveRelayLogInfoRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public SlaveRelayLogInfo where(Condition condition) {
        return new SlaveRelayLogInfo(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public SlaveRelayLogInfo where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public SlaveRelayLogInfo where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public SlaveRelayLogInfo where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public SlaveRelayLogInfo where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public SlaveRelayLogInfo where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public SlaveRelayLogInfo where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public SlaveRelayLogInfo where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public SlaveRelayLogInfo whereExists(Select<?> select) {
     ...
     */
    @Override
    public SlaveRelayLogInfo whereNotExists(Select<?> select) {
