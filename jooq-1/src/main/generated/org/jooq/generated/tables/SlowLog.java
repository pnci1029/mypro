...
public class SlowLog extends TableImpl<SlowLogRecord> {
    ...
    private SlowLog(Name alias, Table<SlowLogRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public SlowLog where(Condition condition) {
        return new SlowLog(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public SlowLog where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public SlowLog where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public SlowLog where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public SlowLog where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public SlowLog where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public SlowLog where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public SlowLog where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public SlowLog whereExists(Select<?> select) {
     ...
     */
    @Override
    public SlowLog whereNotExists(Select<?> select) {
