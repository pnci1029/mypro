...
public class TablesPriv extends TableImpl<TablesPrivRecord> {
    ...
    private TablesPriv(Name alias, Table<TablesPrivRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public TablesPriv where(Condition condition) {
        return new TablesPriv(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public TablesPriv where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public TablesPriv where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public TablesPriv where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public TablesPriv where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public TablesPriv where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public TablesPriv where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public TablesPriv where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public TablesPriv whereExists(Select<?> select) {
     ...
     */
    @Override
    public TablesPriv whereNotExists(Select<?> select) {
