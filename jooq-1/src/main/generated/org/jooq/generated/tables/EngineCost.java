...
public class EngineCost extends TableImpl<EngineCostRecord> {
    ...
    private EngineCost(Name alias, Table<EngineCostRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public EngineCost where(Condition condition) {
        return new EngineCost(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public EngineCost where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public EngineCost where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public EngineCost where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public EngineCost where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public EngineCost where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public EngineCost where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public EngineCost where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public EngineCost whereExists(Select<?> select) {
     ...
     */
    @Override
    public EngineCost whereNotExists(Select<?> select) {
