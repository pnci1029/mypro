...
public class ColumnsPriv extends TableImpl<ColumnsPrivRecord> {
    ...
    private ColumnsPriv(Name alias, Table<ColumnsPrivRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public ColumnsPriv where(Condition condition) {
        return new ColumnsPriv(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ColumnsPriv where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ColumnsPriv where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ColumnsPriv where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ColumnsPriv where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ColumnsPriv where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ColumnsPriv where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ColumnsPriv where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ColumnsPriv whereExists(Select<?> select) {
     ...
     */
    @Override
    public ColumnsPriv whereNotExists(Select<?> select) {
